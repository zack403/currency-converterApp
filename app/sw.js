...
let contentImgsCache = 'currency-converter-content-imgs';
...
open.onupgradeneeded = () => {
    var db = open.result;
    var store = db.createObjectStore("CurrencyConverter", {keyPath: "id"});
    var index = store.createIndex("CurrencyNameIndex", ["Currency.CurrencyName", "Currency.CurrencySymbol"]);
};
...
open.onsuccess = () => {
    ...
    var index = store.index("CurrencyName");
